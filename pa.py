...
name1var=StringVar()
name1var.set("Garlic Paste")
name2var=StringVar()
name2var.set("Parachute Oil")
name3var=StringVar()
name3var.set("Arial")
name4var=StringVar()
name4var.set("Garam Masala")
name5var=StringVar()
name5var.set("Vaseline Lotion")
name6var=StringVar()
name6var.set("Surf-Excel")
name7var=StringVar()
name7var.set("Pampers")
name8var=StringVar()
name8var.set("Cumin Seeds")
