...
name1var=StringVar()
name1var.set("Samsung Earphones")
name2var=StringVar()
name2var.set("Wireless Headphones")
name3var=StringVar()
name3var.set("Joggin Earphones")
name4var=StringVar()
name4var.set("True Wireless")
name5var=StringVar()
name5var.set("iphone X cover")
name6var=StringVar()
name6var.set("Oneplus Cover")
name7var=StringVar()
name7var.set("Note7 Pro cover")
name8var=StringVar()
name8var.set("Note5 Pro Cover")
...
price5=Label(root,textvariable=price5var,font=("aerial")).place(x=290,y=500)
name5=Label(root,textvariable=name5var,font=("aerial")).place(x=260,y=530)
price6=Label(root,textvariable=price6var,font=("aerial")).place(x=550,y=500)
name6=Label(root,textvariable=name6var,font=("aerial")).place(x=520,y=530)
price7=Label(root,textvariable=price7var,font=("aerial")).place(x=810,y=500)
name7=Label(root,textvariable=name7var,font=("aerial")).place(x=780,y=530)
price8=Label(root,textvariable=price8var,font=("aerial")).place(x=1070,y=500)
name8=Label(root,textvariable=name8var,font=("aerial")).place(x=1040,y=530)
q=IntVar()
