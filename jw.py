...
name1var=StringVar()
name1var.set("Necklace1")
name2var=StringVar()
name2var.set("Bracelet")
name3var=StringVar()
name3var.set("Ear Ring")
name4var=StringVar()
name4var.set("Necklace2")
name5var=StringVar()
name5var.set("Necklace3")
name6var=StringVar()
name6var.set("Necklace4")
name7var=StringVar()
name7var.set("Necklace5")
name8var=StringVar()
name8var.set("Necklace6")
