...
name3var.set("   Suit")
name4var=StringVar()
name4var.set("  Saree 2")
name5var=StringVar()
name5var.set("  Crop Top")
name6var=StringVar()
name6var.set("  Legging")
name7var=StringVar()
name7var.set("  Shorts")
name8var=StringVar()
name8var.set("     Casuals")
