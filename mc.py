...
name1var=StringVar()
name1var.set("Kurta For Men")
name2var=StringVar()
name2var.set("T-shirt For Men")
name3var=StringVar()
name3var.set("Jeans For Men")
name4var=StringVar()
name4var.set("Trousers For Men")
name5var=StringVar()
name5var.set("Suit For Men")
name6var=StringVar()
name6var.set("  Formal Shirt  ")
name7var=StringVar()
name7var.set("Kurta For Men")
name8var=StringVar()
name8var.set("  Track Pants  ")

price1=Label(root,textvariable=price1var,text="",font=("aerial")).place(x=290,y=220)
name1=Label(root,textvariable=name1var,text="Kurta For Men",font=("aerial")).place(x=260,y=250)
price2=Label(root,textvariable=price2var,text="599",font=("aerial")).place(x=550,y=220)
name2=Label(root,textvariable=name2var,text="T-shirt For Men",font=("aerial")).place(x=520,y=250)
price3=Label(root,textvariable=price3var,text="999",font=("aerial")).place(x=810,y=220)
name3=Label(root,textvariable=name3var,text="Jeans For Men",font=("aerial")).place(x=780,y=250)
price4=Label(root,textvariable=price4var,text="1499",font=("aerial")).place(x=1070,y=220)
name4=Label(root,textvariable=name4var,text="Trousers For Men",font=("aerial")).place(x=1020,y=250)
price5=Label(root,textvariable=price5var,text="2999",font=("aerial")).place(x=290,y=500)
name5=Label(root,textvariable=name5var,text="Suit For Men",font=("aerial")).place(x=260,y=530)
price6=Label(root,textvariable=price6var,text="499",font=("aerial")).place(x=550,y=500)
name6=Label(root,textvariable=name6var,text="  Formal Shirt  ",font=("aerial")).place(x=520,y=530)
price7=Label(root,textvariable=price7var,text="999",font=("aerial")).place(x=810,y=500)
name7=Label(root,textvariable=name7var,text="Kurta For Men",font=("aerial")).place(x=780,y=530)
price8=Label(root,textvariable=price8var,text="899",font=("aerial")).place(x=1070,y=500)
name8=Label(root,textvariable=name8var,text="  Track Pants  ",font=("aerial")).place(x=1040,y=530)
